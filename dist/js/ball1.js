...
var draw = function draw(p) {
    // .globalAlpha(p.alpha)
    graphics.beginPath().arc(p.x, p.y, p.r, 0, Math.PI * 2).closePath().fillStyle(p.color).fill();
};
...
_cax2.default.setInterval(update, 17);

},{"./cax":2}],2:[function(require,module,exports){
'use strict';
